...
if __name__ == '__main__':
	...
	try:
		...
		sock_10.connect(('localhost', 5000))
		sock_10.send(pickle.dumps('Database 5001'))
		print('Connect to Database 5000')
		CONNECTION_LIST.append(sock_10)
		# broadcast_database('Hello from 5001, middle area')
	except:
						...
						if data[0] == 'D':
							...
							if data == 'Client':
								...
								if message[0] == 'write':
									...
									# new add
									DEPENDENCY[client] = [[message[2], DATABASE_TIME[5001], 5001]]
									...
									# DEPENDENCY[client] = [message[1], DATABASE_TIME[5001], DICTIONARY[message[1]]['From']]
									# new add
